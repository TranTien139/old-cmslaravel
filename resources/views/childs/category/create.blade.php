                    ...
                    <form id="addCategory" role="form" method="post">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="parent_id" class="form-control" style="width: 100%;" tabindex="-1"
                                        aria-hidden="true">
                                    <option value="0">{{trans('category.cat_name_none')}}</option>
                                    <?php cate_parent($parentCats,$parent = 0,  $str ="--",$select=0); ?>
                                </select>
                            </div>
                            <div class="form-group">
                                <label>Mô tả</label>
                                <textarea rows="3" class="form-control" placeholder="Nhập mô tả " name="description">
