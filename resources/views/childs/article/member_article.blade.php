    ...
    <section class="content">
        <div>
            <div style="padding-bottom: 5px; margin-bottom: 5px; border-bottom: 1px solid #ddd">
                <form method="get" action="/member/article" autocomplete="off" role="form" class="form-inline">
                    ...
                    <div class="form-group">
                        <select class="form-control" name="event" data-live-search="true" data-width="120px">
                            <option value="" @if(!isset($request_all['event'])){{"selected"}}@endif >{{ trans('article.event') }}</option>
                            @foreach( $event as $item )
                                <option value="{{ $item->id }}" @if(isset($request_all['event']) && (int)$request_all['event'] ==$item->id ){{"selected"}}@endif>{{ $item->event_name }} </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <div>
                            <table class="table table-striped">
                                ...
                                @foreach($articles as $article)
                                    <?php
                                    $event_name = '';
                                    if (isset($article->getEvent)) {
                                        $event_name = $article->getEvent->event_name;
                                    }
                                    ?>
                                    <tr id="" class="post-item post-id-{{$article['id']}}">
                                        <td>
                                            ...
                                            <p>
                                                ...
                                                ?>
                                                <a href="/media/{{$path}}/edit/{{$article->id}}?member=thanhvien">Edit</a>
                                                &nbsp;&nbsp;
                                        ...
                                        <td><p style="color:red;font-weight: bold;">{{ $event_name }}</p></td>
