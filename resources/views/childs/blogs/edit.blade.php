                    ...
                    <div class="box-body">
                        ...
                        if (str_contains($article->thumbnail_extra, 'http') === false) {
                            ...
                            <img onclick="BrowseServer('id_of_the_target_input_extra');"
                             src="{{ env('MEDIA_PATH') . str_replace(env('REPLACE_PATH') , '' , $article->thumbnail_extra )}}"
                ...
                @endif
                    ...
                    <div class="box-body">
                        <select class="type_article form-control" name="type_article">
                            <option value=""></option>
                            <option value="Video" @if($article->type_article == 'Video') selected @endif>Video</option>
                        </select>
                    </div><!-- /.box-body -->
                </div><!-- /.box -->
                        <?php
                                        ...
                                        <div class="category">
                                            @foreach( $$k as $item )
                                                <div class="form-group category-item">
                                                    ...
                                                    <i class="fa fa-flag flag_click" @if($article->parent_category == $item->id ) style="color:red" @endif  data-id="{{$item->id}}"></i>
                                                </div>
                                            @endforeach
