                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="media_path"
                                                   value="{{trim($video->file_path)}} ">
                                            @if(!str_contains('http' ,$video->file_path ))
                                                <video src="{{env('VIDEO_PATH').trim($video->file_path)}}"
                                                       width="300" controls></video>
                                            @else
                                                <video src="{{trim($video->file_path)}}" width="300"
                                                       controls></video>
                                            @endif
                ...
                <div class="col-md-3">
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                            ...
                            ?>
                            <img src="{{ env('MEDIA_PATH') . str_replace(env('REPLACE_PATH') , '' , $video->thumbnail )}}"
                                 onclick="BrowseServer('id_of_the_target_input');" id="image_replace"
                                 style="margin-top:-28px;cursor: pointer;max-height: 200px;width:100%;@if($video->thumbnail == '')display:none; @endif">
                            <?php
                            } else {
                            ?>
                            ...
                            <div class="preview-placeholder" id="replace"
                                 @if($video->thumbnail != '')style="display:none;" @endif>
                                <div>
